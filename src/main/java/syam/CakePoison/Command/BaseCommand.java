...
public abstract class BaseCommand {
	// Logger
	protected static final Logger log = CakePoison.log;
	protected static final String logPrefix = CakePoison.logPrefix;
	protected static final String msgPrefix = CakePoison.msgPrefix;
	/* コマンド関係 */
	...
	public CakePoison plugin;

	public boolean run(CakePoison plugin, CommandSender sender, String[] preArgs, String cmd) {
		this.plugin = plugin;
		this.sender = sender;
		this.command = cmd;
